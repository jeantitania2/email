...
"------------INTERFAZ TKINTER------------"
ventana =Tk()
ventana.title("ALICACION DE MENSAJERIA MERKADMON")
...
Label(ventana, text="Mi correo: merkadmon@gmail.com",fg="white",bg="blue",font=("Arial", 10,"bold"),padx=5,pady=5).grid(row=2,column=0,columnspan=2,pady=5)
...
def enviar_email():
    ...
    smtp.login(remitente, "pfheulxxugqagxdx")
